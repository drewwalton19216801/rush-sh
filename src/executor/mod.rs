...
pub(crate) use expansion::{expand_variables_in_args, expand_wildcards};

// Re-export redirection functions
pub use redirection::apply_redirections;
pub(crate) use redirection::write_file_with_noclobber_public;
